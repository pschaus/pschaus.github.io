...
I then spent two years at the UCLouvain spin-off <a href="https://www.n-side.com/">N-SIDE</a>, where I initiated the development of the <a href="https://github.com/pschaus/oscar">OscaR solver</a>, before returning to UCLouvain as faculty in 2012. I continued leading the development of CP solver of OscaR until its retirement, after which it was succeeded by <a href="https://github.com/minicp/minicp">MiniCP</a> and <a href="https://github.com/aia-uclouvain/maxicp">MaxiCP</a>, which I actively maintain.<br>

In recent years, my research has increasingly focused on decision-diagram-based optimization, a topic pioneered by Willem-Jan van Hoeve and John Hooker team. In collaboration with Cetic, we are now developing <a href="https://github.com/DDOLIB-CETIC-UCL/DDOLib">DDOLib</a>, a solver built around these techniques. I also had a very fruitful collaboration with my former colleague Siegfried Nijssen the past years on algorithms for learning exact or less-greedy decision trees, during which we extended and exploited an idea originally developed by him and Lisa Fromont (DL8 algorithm) involving dynamic programming.<br>
